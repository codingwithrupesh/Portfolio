...
import { avatar, raj,rahulImg , abhi} from '../../assets';
      ...
      /> */}
        <div className="w-full">
            <div className="w-full h-auto flex flex-col lgl:flex-row justify-between">
              ...
              <img
                // className="h-96 md:h-72 lgl:h-96 w-full rounded-lg object-contain"
                className="h-auto md:h-auto lgl:h-auto w-full max-h-[400px] max-w-[250px] rounded-lg object-cover"
                src={raj}
                alt="testimonialTwo"
              />
                <div className="w-full flex flex-col justify-end">
                 ...
                 TEAM MEMBER A
                  ...
                  <h3 className="text-2xl font-bold">RUPESH KUMAR</h3>
                ...
                <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8">
                  <div className="flex flex-col justify-between lgl:items-center py-6 border-b-2 border-b-gray-900">
                    <div>
                      ...
                      <p className="text-base text-gray-400 mt-3 flex justify-center content-center">
                        via Upwork - 2022
                      </p>
                    </div>
